...
public class Classwork8
{
    public static void main(String[] args)
    {
        ...
        System.out.println(raceToday(30, false));
        System.out.println(raceToday(450, false));
        System.out.println(raceToday(700, true));
        System.out.println(raceToday(850, false));
    ...
    **/
    ...
    {               
        if ((isFriday == true) && ((size>=150)&&(size<=800)))
        {
            return true;
    ...
    /** Question 12: 
    ** Define a function to determine if a number entered is even, then returns that number times 5. If ** the number entered is odd and is divisible by 5, then the function returns that number divided by five. If the 
    ...
    **/
    ...
    {               
        if ((number%2== 1)&&(number%5 == 0))//even return *5
        {
            return number/5;
        }
        else if (number%2== 0){
            return number*5;
        }//** the number entered is odd and is divisable by five then divide by 5
        
        else if (number%2== 1)
       {
           return number*3;
        
       }//number is odd and not divisable by 5 then return three times the number
